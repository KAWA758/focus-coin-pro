...
const Stats = () => (
  <div className="px-5 pt-14 pb-6 animate-fade-in">
    ...
    <p className="text-sm text-muted-foreground mb-6">Your focus performance</p>

    {/* Summary cards */}
    <div className="grid grid-cols-3 gap-3 mb-8">
      {[
        { label: "Total Focus", value: "48h 22m", sub: "This month" },
        { label: "Coins Earned", value: "3,450", sub: "All time" },
        { label: "Best Streak", value: "12 days", sub: "Personal best" },
      ].map((s, i) => (
    ...
    <div className="bg-card rounded-2xl p-5 card-shadow">
      <h3 className="text-sm font-semibold text-foreground mb-4">Coins Earned</h3>
      <ResponsiveContainer width="100%" height={140}>
